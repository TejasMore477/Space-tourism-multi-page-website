  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[88vh] text-white flex flex-col items-center justify-around pt-3 sm:px-10 px-6 pb-10">
        <p className="sm:text-[2.7vw] text-[3vw] font-light text-center">03 Space launch 101</p>
        ...
        <div className="flex items-center justify-center gap-5 mt-4">
          {techData.map((e, i) => (
            <button
              key={i}
              onClick={() => setTi(i)}
              className={`sm:text-[2.5vw] text-[3vw] font-light ${
        ...
        The terminology...
          ...
          <p className=" h-[15vh] mb-5 sm:text-[2.7vw] text-[3.4vw] leading-tight font-light mt-2 px-4">
