    ...
    >
      ...
      <div className="w-full h-[88vh] text-white flex flex-col items-center justify-evenly pt-3 sm:px-10 px-6 pb-10">
        ...
        <div className="flex items-center justify-center gap-5 md:mt-5 lg:mt-3">
          {crewData.map((e, i) => (
            <button
              key={i}
              onClick={() => setCi(i)}
              className={`lg:text-[1.7vw] md:text-[2vw] sm:text-[2.6vw] text-[4vw] font-light ${
        ...
        <div className="text-center">
          <h3 className="lg:text-[1.7vw] md:text-[2vw] sm:text-[2.8vw] text-[4vw] text-zinc-400 font-semibold uppercase leading-none lg:py-3 md:py-5 py-2">
           {crewData[ci].role}
          </h3>
          <h2 className="mb-5 lg:text-[5vw] md:text-[6vw] sm:text-[7vw]  text-[8vw] uppercase font-light leading-none">
            {crewData[ci].name}
          </h2>
          <p className="h-[12vh] md:mb-5 lg:mb-0 lg:text-[1.8vw] md:text-[2vw]  sm:text-[2.7vw] text-[3.4vw] leading-tight font-light mt-2 px-4">
            {crewData[ci].bio}
          </p>
        </div>
      </div>
