  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[88vh] text-white flex flex-col items-center md:justify-center justify-around pt-3 sm:px-10 px-6 pb-10">
        <p className="md:text-[2.4vw] sm:text-[2.7vw] text-[3vw] font-light text-center">
          01 Pick your destination
        </p>

        <img
          className="md:size-[22vw] sm:size-[28vw] size-[40vw] mt-5 md:my-5"
        ...
        <div className="flex items-center justify-center gap-5 mt-4">
          {destData.map((e, i) => (
            <button
              key={i}
              onClick={() => setDi(i)}
              className={`md:text-[1.7vw] sm:text-[2vw] text-[3vw] font-light ${
        ...
        <div className="mt-3 text-center">
          ...
          <p className="h-[10vh] mb-3 md:text-[2vw]  sm:text-[2.4vw] text-[3vw] leading-tight font-light mt-2 px-4">
          ...
          <div>
          <h3 className="mt-3 md:text-[2vw] sm:text-[2.6vw] text-[3.3vw] text-zinc-400 font-semibold uppercase leading-none tracking-tighter py-2">
            Avg. distance
          </h3>
          <h2 className="md:text-[3.7vw] md:mt-1 sm:text-[4.3vw] text-[5.3vw] tracking-tight font-semibold italic leading-none">
            {destData[di].distance}
          </h2>
          </div>
          <div>
          <h3 className="md:mt-3 mt-5 md:text-[2vw] sm:text-[2.6vw] text-[3.3vw] text-zinc-400 font-semibold uppercase leading-none tracking-tighter py-2">
            Est. travel time
          </h3>
          <h2 className="md:text-[3.7vw] md:mt-1 sm:text-[4.3vw] text-[5.3vw] tracking-tight font-semibold italic leading-none">
            {destData[di].travel}
